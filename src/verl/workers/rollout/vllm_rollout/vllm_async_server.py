...
@ray.remote(num_cpus=1)
class AsyncvLLMCompletionServer:
    """
    Similar to AsyncvLLMServer but used to serve completion API.
    """
    ...
    async def completion_generator(self, request: CompletionRequest) -> AsyncGenerator[Tuple[int, str]]:
        """Direct chat completion without FastAPI.
